      ...
      <div className="text-white flex flex-col gap-8 mb-16">
          ...
          <ul className="md:flex hidden gap-10">
            {menuItem.map((item) => (
              <li className="w-fit" key={item.id}>
                {item.id === 1 ? (
                  <a
                    className="no-underline text-2xl hover:text-primary duration-500 font-bellefair text-primary"
                    href={item.href}
                  >
                    {item.name}
                  </a>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="w-full flex md:flex-row flex-col md:gap-0 gap-4 justify-between">
            ...
            <div className="md:w-[49%] md:h-[600px] h-[300px] relative md:block hidden">
              <img
                src={MyPic}
                alt="Mr.MohammadMahdiGholipour"
